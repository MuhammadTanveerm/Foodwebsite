...
const renderRatingIcons=( rating ) => {
  ...
  for (let i = 0 ; i < 5; i++) {
    if ( rating>0.5) {
      ...
      // Empty star
      stars.push(<FaStar key={`empty${i}`} style={{ opacity: 0.5 }} />)
    }
  }
return stars;
}
      ...
      <Container>
        <Row>
          <Col lg={{ span: 8, offset: 2 }} className="text-center mb-5">
            <h2> OUR CRAZY BURBERS</h2>
            <p className="para">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vero
              accusamus, repellat qui distinctio assumenda tempora?
            </p>
          </Col>
        </Row>
        <Row>
        ...
        <Row>
          <Col sm={6} lg={5}> 
           <div className="ads-box add_img1 mb-5 mb-md-0">
            <h4>Get Order</h4>
            <h5>Cheese Fries</h5>
            <Link to="/" className="btn btn_red px-5 rounded-0 "> Learn More</Link>
           </div>
          </Col>
          <Col sm={6} lg={7}> 
           <div className="ads-box add_img2">
            <h4>Get Order</h4>
            <h5>Cheese Fries</h5>
            <Link to="/" className="btn btn_red px-5 rounded-0 "> Learn More</Link>
           </div>
